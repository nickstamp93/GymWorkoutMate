...
public class Contract {
    ...
    public static void createExercises(Context context, SQLiteDatabase db) {
        ...
        //CHEST
        initExercises.add(new Exercise("Barbell Bench Press - Medium Grip", "barbell_bench_press_medium1", "barbell_bench_press_medium2"
                , EnumMuscleGroups.CHEST, "3-5", 1, EnumEquipment.BARBELL));
        initExercises.add(new Exercise("Barbell Bench Press - Wide Grip", "barbell_bench_press_wide1", "barbell_bench_press_wide2"
                , EnumMuscleGroups.CHEST, "3-5", 1, EnumEquipment.BARBELL));
